...
public class DateCalculatorTest {
    ...
    public static Map<Integer, java.util.List<MonthlyZodiacModel>> monthMap = new HashMap<>();
    ...
    public void populateMonthlyZodiac_returnsAll12Signs_populatesHashMap(){
        ...
        // 2. List populates hashmap
        int counter = 0;
        for( List<MonthlyZodiacModel> zodiacs : monthMap.keySet()){
            counter ++;
        }

        if( counter == 12){
            Assertions.assertNotNull(monthMap.entrySet());
